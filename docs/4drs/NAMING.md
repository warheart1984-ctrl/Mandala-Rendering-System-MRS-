# Formal naming — 4D Rendering System v1.0
...
**Release title (GitHub + Zenodo):** `4D Rendering System v1.0`

Do not conflate 4DRS (published system + RT4D) with full multi-host “production ready” claims. Host maturity remains evidence-tagged in `constitution/CHARTER.md`.
